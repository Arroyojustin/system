<div class="sidebar-container d-none d-md-flex flex-column p-0 m-0">
    ...
    <nav>
        <a href="#" class="sidebar-link" onclick="showSection(event, 'front')">
...
<script>
    function showSection(event, sectionID) {
        ...
        // Hide all sections
        document.querySelectorAll('#front, #history').forEach(section => {
    ...
    window.onload = function() {
        ...
        showSection(null, 'front'); 

        // Mark the dashboard link as active on load
        document.querySelector('a[href="#"][onclick*="front"]').classList.add('active');
    };
</script>