<div class="sidebar-container d-none d-md-flex flex-column p-0 m-0">
    ...
    <nav>
        ...
        <a href="#" class="sidebar-link" onclick="showSection(event, 'admin_tasks')">
...
<script>
    function showSection(event, sectionID) {
        ...
        // Hide all sections
        document.querySelectorAll('#home, #reports, #students, #attendance, #admin_tasks, #profile').forEach(section => {
